...
})({"9Y31s":[function(require,module,exports) {
...
*/ async function run() {
    ...
    const swc = await eval(`import("https://cdn.jsdelivr.net/npm/@swc/wasm-web@1.3.78/wasm-web.js")`);
    await swc.default(); // init bindgen
    console.log("Loaded ✅");
    formElement.addEventListener("submit", (event1)=>{
        event1.preventDefault();
        codeDisplay.innerText = JSON.stringify(swc.parseSync(inputElement.value, {
            syntax: "typescript",
            tsx: false,
            target: "es2022",
            isModule: true
...
},{}]},["9Y31s","bB7Pu"], "bB7Pu", "parcelRequireb3b2")
